...
function highlight(language, value, options = {}) {
    ...
    if (typeof language !== 'string') {
        throw 'Expected `string` for name, got'
    }

    if (!high.getLanguage(language)) {
        throw 'Unknown language: `%s` is not registered'
    }

    if (typeof value !== 'string') {
        throw 'Expected `string` for value, got'
    }
    ...
    // @ts-expect-error: `relevance` is always defined in `relevance`.
